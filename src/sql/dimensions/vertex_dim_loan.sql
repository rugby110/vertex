...
select l.id as loan_id,
	...
	case when sp.sp_badges like '%Client Voice%' then true else false end as sp_client_voice_focus,
	case when sp.sp_badges like '%Family and Community Empowerment%' then true else false end as sp_family_and_community_empowerment_focus,
	case when sp.sp_badges like '%Entrepreneurial Support%' then true else false end as sp_entrepreneurial_focus,
	case when sp.sp_badges like '%Facilitation of Savings%' then true else false end as sp_facilitation_of_savings_focus,
	case when sp.sp_badges like '%Innovation%' then true else false end as sp_innovation_focus,
	am.sector_id,
	t.id as geo_id,
