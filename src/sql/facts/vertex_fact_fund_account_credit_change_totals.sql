...
select fund_account_id,
  ...
  sum(loan_purchase_num) as loan_purchase_num,
  sum(loan_purchase_total) as loan_purchase_total,
  sum(loan_purchase_modification_num) as loan_purchase_modification_num,
  sum(loan_purchase_modification_total) as loan_purchase_modification_total,
  sum(loan_purchase_auto_num) as loan_purchase_auto_num,
  sum(loan_purchase_auto_total) as loan_purchase_auto_total,
  sum(loan_expired_num) as loan_expired_num,
  sum(loan_expired_total) as loan_expired_total,
  sum(loan_expired_modification_num) as loan_expired_modification_num,
  sum(loan_expired_modification_total) as loan_expired_modification_total,
  sum(loan_refund_num) as loan_refund_num,
  sum(loan_refund_total) as loan_refund_total,
  sum(loan_refund_modification_num) as loan_refund_modification_num,
  sum(loan_refund_modification_total) as loan_refund_modification_total,
  sum(gift_purchase_num) as gift_purchase_num,
  sum(gift_purchase_total) as gift_purchase_total,
  sum(gift_purchase_modification_num) as gift_purchase_modification_num,
  sum(gift_purchase_modification_total) as gift_purchase_modification_total,
  sum(gift_redemption_num) as gift_redemption_num,
  sum(gift_redemption_total) as gift_redemption_total,
  sum(gift_expiration_num) as gift_expiration_num,
  sum(gift_expiration_total) as gift_expiration_total,
  sum(gift_expiration_modification_num) as gift_expiration_modification_num,
  sum(gift_expiration_modification_total) as gift_expiration_modification_total,
  sum(gift_expiration_donation_num) as gift_expiration_donation_num,
  sum(gift_expiration_donation_total) as gift_expiration_donation_total,
  sum(gift_expiration_donation_modification_num) as gift_expiration_donation_modification_num,
  sum(gift_expiration_donation_modification_total) as gift_expiration_donation_modification_total,
  sum(withdrawal_num) as withdrawal_num,
  sum(withdrawal_total) as withdrawal_total,
  sum(withdrawal_modification_num) as withdrawal_modification_num,
  sum(withdrawal_modification_total) as withdrawal_modification_total,
  sum(donation_num) as donation_num,
  sum(donation_total) as donation_total,
  sum(donation_modification_num) as donation_modification_num,
  sum(donation_modification_total) as donation_modification_total,
  sum(donation_auto_num) as donation_auto_num,
  sum(donation_auto_total) as donation_auto_total,
  sum(loan_repayment_num) as loan_repayment_num,
  sum(loan_repayment_total) as loan_repayment_total,
  sum(loan_repayment_currency_loss_num) as loan_repayment_currency_loss_num,
  sum(loan_repayment_currency_loss_total) as loan_repayment_currency_loss_total,
  sum(deposit_num) as deposit_num,
  sum(deposit_total) as deposit_total,
  sum(deposit_modification_num) as deposit_modification_num,
  sum(deposit_modification_total) as deposit_modification_total,
  sum(misc_num) as misc_num,
  sum(misc_total) as misc_total,
  sum(fundpool_repayment_num) as fundpool_repayment_num,
  sum(fundpool_repayment_total) as fundpool_repayment_total,
  sum(fundpool_match_num) as fundpool_match_num,
  sum(fundpool_match_total) as fundpool_match_total,
  sum(kivapool_repayment_num) as kivapool_repayment_num,
  sum(kivapool_repayment_total) as kivapool_repayment_total,
  sum(kivapool_match_num) as kivapool_match_num,
  sum(kivapool_match_total) as kivapool_match_total,
  sum(promo_loan_credit_num) as promo_loan_credit_num,
  sum(promo_loan_credit_total) as promo_loan_credit_total,
  sum(promo_loan_reimbursement_num) as promo_loan_reimbursement_num,
  sum(promo_loan_reimbursement_total) as promo_loan_reimbursement_total,
  sum(cc_user_num) as cc_user_num,
  sum(cc_user_total) as cc_user_total,
  sum(uncategorized_num) as uncategorized_num,
  sum(uncategorized_total) as uncategorized_total
