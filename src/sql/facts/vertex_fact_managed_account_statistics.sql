...
SELECT fact_cc.effective_day_id,
       ...
       CASE WHEN (fact_cc.credit_change_type_id IN 
        ( SELECT vertex_dim_credit_change_type.credit_change_type_id
...
JOIN vertex_dim_credit_change_type dimcct ON ((dimcct.credit_change_type_id = fact_cc.credit_change_type_id))) 
...
SELECT fact_cc.effective_day_id,
        ...
        0 AS fx_loss_amount,
        CASE WHEN (fact_cc.credit_change_type_id IN 
        ( SELECT cct.credit_change_type_id AS credit_change_type_id
