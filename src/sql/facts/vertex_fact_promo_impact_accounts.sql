...
inner join verse_ods_kiva_login_fund_account_mapper lfam on llp.lender_fund_account_id = lfam.fund_account_id and lfam.is_owner = 'yes'
...
inner join verse_ods_kiva_login_fund_account_mapper lfam on i.invitee_id = lfam.login_id and lfam.is_owner = 'yes'
