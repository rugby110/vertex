...
class FactFundAccountTest extends Kiva\Vertex\Testing\VertexTestCase {
	...
	public function testSample() {
		$result = $this->db->query("select fund_account_id, fundpool_match_total, kivapool_match_total, loan_purchase_total, loan_purchase_num, loan_purchase_auto_total, loan_repayment_total, fundpool_repayment_total, kivapool_repayment_total, loan_refund_total, loan_expired_total, loan_repayment_currency_loss_total, loan_default_total
			from $this->vertex_schema.vertex_fact_fund_account
